...
const Card = ({ card, onClick }) => {
  ...
  return (
    <div
      ref={cardRef}
      className={`flex-shrink-0 w-[290px] h-[335px] mx-4 my-8 bg-gray-100 rounded-3xl snap-center shadow-md p-4 flex flex-col items-start cursor-pointer transform transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-xl hover:bg-gray-50 ${
