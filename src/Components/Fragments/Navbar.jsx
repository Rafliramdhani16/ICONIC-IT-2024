...
import SearchBar from "../Elements/Navbar/Search";
...
const Navbar = () => {
  ...
  return (
    <nav className="flex items-center justify-between p-3 bg-white xl:rounded-b-[30px] md:rounded-b-[30px] fixed top-0 left-0 right-0 w-full z-50 shadow-md">
