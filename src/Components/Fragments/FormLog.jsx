...
const FormLog = () => {
  ...
  return (
    <div className="w-full max-w-md bg-white rounded-3xl shadow-md p-6">
      ...
      <h2 className="text-2xl font-semibold text-neutral-800 my-6">Masuk</h2>
      {message && (
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button
          ...
          className="w-full text-blue-600 bg-white py-2 border border-blue-600 rounded-full mt-4 hover:bg-blue-600 hover:text-white hover:border-blue-600 mb-4"
        >
          daftar
        </button>
      </form>
